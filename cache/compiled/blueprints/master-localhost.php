...
return [
    ...
    'checksum' => '72795c52171fba3c79a2f2ac0f8eebf5',
    'files' => [
        ...
        'user/plugins' => [
            'plugins/editor-buttons' => [
                'file' => 'user/plugins/editor-buttons/blueprints.yaml',
                'modified' => 1474266410
            ],
            'plugins/email' => [
    ...
    'data' => [
        'items' => [
            ...
            'plugins.editor-buttons.enabled' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.editor-buttons.enabled',
                'validation' => 'loose'
            ],
            'plugins.editor-buttons.insert_table' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.editor-buttons.insert_table',
                'validation' => 'loose'
            ],
            'plugins.editor-buttons.insert_notice' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.editor-buttons.insert_notice',
                'validation' => 'loose'
            ],
            'plugins.editor-buttons.buttons' => [
                'type' => 'section',
                'underline' => true,
                'name' => 'plugins.editor-buttons.buttons',
                'validation' => 'loose'
            ],
            'plugins.email' => [
                'form' => [
        ...
        'nested' => [
            ...
            'plugins' => [
                'editor-buttons' => [
                    'enabled' => 'plugins.editor-buttons.enabled',
                    'buttons' => 'plugins.editor-buttons.buttons',
                    'insert_table' => 'plugins.editor-buttons.insert_table',
                    'insert_notice' => 'plugins.editor-buttons.insert_notice'
                ],
                'email' => [
